...
def main():
    ...
    parser.add_argument("--model-config", default="configs/DINOv2_large_model_configs.yml", help="Path to model YAML config")
    parser.add_argument("--input", default=None, help="DINOv2 variant (e.g. dinov2_vitl14)")
    ...
    if args.model_config and Path(args.model_config).exists():
        ...
        backbone_name = args.input or "dinov2_vitl14"
        cache_path = args.output or "ckpts/facebookresearch--dinov2-dinov2_vitl14"
